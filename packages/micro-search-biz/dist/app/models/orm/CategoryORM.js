...
exports.CategoryORM = void 0;
const common_1 = require("@micro-fleet/common");
const persistence_1 = require("@micro-fleet/persistence");
const date_utils_1 = require("../../utils/date-utils");
let CategoryORM = class CategoryORM extends persistence_1.ORMModelBase {
    constructor() {
        super(...arguments);
...
CategoryORM = __decorate([
    common_1.decorators.translatable()
], CategoryORM);
exports.CategoryORM = CategoryORM;
//# sourceMappingURL=CategoryORM.js.map