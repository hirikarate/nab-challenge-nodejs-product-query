...
exports.RemoteProductMediateService = void 0;
...
const { Action: A } = dto;
let RemoteProductMediateService = class RemoteProductMediateService extends RemoteServiceBase_1.RemoteServiceBase {
    constructor(rpcCaller) {
        super(dto.MODULE_NAME, rpcCaller);
        debug('RemoteProductMediateService instantiated');
    }
    /**
...
], RemoteProductMediateService.prototype, "getById", null);
__decorate([
    cache_1.cacheable({
    ...
    __metadata("design:returntype", Promise)
], RemoteProductMediateService.prototype, "getList", null);
__decorate([
    cache_1.cacheable({
    ...
    __metadata("design:paramtypes", [dto.GetProductListRequest]),
    __metadata("design:returntype", Promise)
], RemoteProductMediateService.prototype, "getRecalledList", null);
RemoteProductMediateService = __decorate([
    __param(0, common_1.decorators.inject(service_communication_1.Types.MEDIATE_RPC_CALLER)),
    __metadata("design:paramtypes", [Object])
], RemoteProductMediateService);
exports.RemoteProductMediateService = RemoteProductMediateService;
//# sourceMappingURL=RemoteProductMediateService.js.map