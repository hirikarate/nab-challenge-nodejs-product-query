...
const PRODUCT_FIELDS = ['id', 'name', 'price', 'color', 'status', 'createdAt', 'updatedAt'];
const FIELDS_RULE = { items: joi.string().valid(...PRODUCT_FIELDS) };
const PRODUCT_RELATIONS = ['branches', 'category'];
